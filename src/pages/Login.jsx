  ...
  return (
    <section>
      <div className="grid grid-cols-1 lg:grid-cols-2">
        <div className="relative flex items-end px-4 pb-10 pt-60 mt-44 mb-9  sm:px-6 sm:pb-16 md:justify-center lg:px-8 lg:pb-24">
          ...
          <div className="relative">
            <div className="w-full max-w-xl xl:mx-auto xl:w-full xl:max-w-xl xl:pr-24">
              <h3 className="text-4xl font-bold text-white">
                Now you dont have to worry We got ur Fashion here!
              </h3>
          ...
          <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
            ...
            <form onSubmit={signUpFormHandler}  className="mt-8">
              <div className="space-y-5">
                <div>
                  <label className="text-base font-medium text-gray-900" htmlFor="email">
                    {" "}
                    Email address{" "}
                  </label>
                  <div className="mt-2">
                ...
                <div>
                  <div className="flex items-center justify-between">
                    <label className="text-base font-medium text-gray-900" htmlFor="password">
                      {" "}
                      Password{" "}
                    </label>
                    <NavLink
